  ...
  return (
    <LinearGradient
      ...
      <View style={{flexDirection: 'row', gap:10, marginBottom:20}}>
        <SelectionButton  title='Past' setSelected={()=> setSelected("Past")} selected={selected}/>

        <SelectionButton  title='Today' setSelected={()=> setSelected("Today")} selected={selected}/>

        <SelectionButton  title='Future' setSelected={()=> setSelected("Future")} selected={selected}/>
      </View>
        ...
        return(
          <View style={{borderWidth:1, borderTopRightRadius: item.top ? 10 : 0, borderTopLeftRadius: item.top ? 10 : 0, borderBottomRightRadius: item.bottom ? 10 : 0, borderBottomLeftRadius: item.bottom ? 10 : 0, padding:20, flexDirection:'row', alignItems:'center', justifyContent:'space-between', borderBottomWidth: item.bottom ? 1 :0 }}>
            <View style={{flexDirection:'row', gap:10, alignItems:'center'}}>
              <View style={{height:20, width:20, borderRadius:200, borderWidth:1, borderColor:"#4C9E00", alignItems:'center', justifyContent:'center'}}>
                <View style={{height:15, width:15, borderRadius:200, backgroundColor:"#4C9E00"}}/>
              </View>
