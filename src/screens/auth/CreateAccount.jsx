...
const CreateAccount = ({navigation}) => {
  const internetConnection = useSelector(
    state => state?.blacklist?.isInternetConnected,
  );
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <View style={{alignItems: 'center', justifyContent: 'center'}}>
          ...
          <AppText
            title={
              'Sign up to access the most accurate pollen and spore forecasts that uses actual data, 32 years of modelling and an accuracy rate of 80% annually'
            }
        ...
        <View style={{gap: 20}}>
          ...
          <AppTextInput
            ...
            password={
              <Ionicons
                name={!SecurePassword == true ? 'eye' : 'eye-off'}
          ...
          <AppTextInput
            ...
            secure={confirmSecurePassword}
            textInput={true}
            password={
              <Ionicons
                name={!confirmSecurePassword == true ? 'eye' : 'eye-off'}
                size={responsiveFontSize(2)}
              />
            }
            onEyePress={() => setConfirmSecurePassword(!confirmSecurePassword)}
            eye={SecurePassword}
          ...
          />
          <AppText
            title={'Help Us With Pollen Research: This data is not mandatory but could be used for anonymous statistical research only. We can’t trace it back to you.'}
            textSize={1.6}
            textColor={AppColors.LIGHTGRAY}
          />
          ...
          <AppTextInput
            title="Phone"
            textInput
            inputPlaceHolder={'+1 (xxx) 222-2222'}
